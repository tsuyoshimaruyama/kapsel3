 ...
 */
inline double qtn_q0(const quaternion &q) { return q.s; }
/*!
  \brief Get q1 component of quaternion
 */
inline double qtn_q1(const quaternion &q) { return q.v[0]; }
/*!
  \brief Get q2 component of quaternion
 */
inline double qtn_q2(const quaternion &q) { return q.v[1]; }
/*!
  \brief Get q3 component of quaternion
 */
inline double qtn_q3(const quaternion &q) { return q.v[2]; }
/*!
  \brief Get scalar component of quaternion
 */
inline void qtn_scalar(double &a, const quaternion &q) { a = q.s; }
/*!
 ...
 */
inline void qtn_init(quaternion &q, const double &a0, const double &a1, const double &a2, const double &a3) {
  q.s = a0;
  q.v[0] = a1;
  q.v[1] = a2;
  q.v[2] = a3;
 ...
 */
inline void qtn_scale(quaternion &q, const quaternion &qa, const double alpha) {
  q.s = qa.s*alpha;
  q.v[0] = qa.v[0]*alpha;
  q.v[1] = qa.v[1]*alpha;
  q.v[2] = qa.v[2]*alpha;
 ...
 */
inline void qtn_add(quaternion &q, const quaternion &qa, const quaternion &qb, const double alpha = 1.0) {
  q.s = qa.s + qb.s*alpha;
 ...
 */
inline void qtn_add(quaternion &q, const quaternion &qb, const double alpha = 1.0) {
  q.s += qb.s*alpha;
  q.v[0] += qb.v[0]*alpha;
  q.v[1] += qb.v[1]*alpha;
  q.v[2] += qb.v[2]*alpha;
 ...
 */
inline void qtn_prod(quaternion &q, const quaternion &qa, const quaternion &qb, const double alpha = 1.0) {
  //scalar part
...
/*!
  \brief qpq = q.p.q*
 */
inline void qtn_qpq_prod(quaternion &qpq, const quaternion &q, const quaternion &p, const double alpha = 1.0) {
  double qs2   = q.s*q.s;
...
/*!
  \brief qvq = q.(0,v).q*
 */
inline void qtn_qvq_prod(double qvq[DIM], const quaternion &q, const double v[DIM], const double alpha = 1.0) {
  //vector part
 ...
 */
inline void qtn_prod(quaternion &q, const quaternion &qb, const double alpha = 1.0) {
  quaternion qa;
  qtn_init(qa, q);
 ...
 */
inline double qtn_norm_s(const quaternion &q) { return ABS(q.s); }

/*!
  \brief Compute norm of imaginary part
 */
inline double qtn_norm_v(const quaternion &q) { return sqrt(q.v[0] * q.v[0] + q.v[1] * q.v[1] + q.v[2] * q.v[2]); }
 ...
 */
inline int qtn_cmp(const quaternion &qa, const quaternion &qb, const double tol = LARGE_TOL_MP) {
    bool equalq = equal_tol(qa.s, qb.s, tol) && equal_tol(qa.v[0], qb.v[0], tol) && equal_tol(qa.v[1], qb.v[1], tol) &&
 ...
 */
inline void rqtn_euler(double &psi, double &theta, double &phi, const quaternion &q) {
  const double &q0 = q.s;
