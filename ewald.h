...
class parallelepiped {
   public:
     ...
     */
    void distance_MI(const double r1[DIM], const double r2[DIM], double r12[DIM]) const;
    /*
...
class ewald {
   public:
     ...
     */
    void reset(double* force, double* torque, double* efield, double* efield_grad);
     ...
     */
    void compute_torque(double* torque, double const* efield, double const* efield_grad, double const* mu) const;
    void compute_force_externalfield_q(double*       force,
                                       const double* q,
                                       const double  efield_x,
                                       const double  efield_y,
                                       const double  efield_z) const;

    void compute_upol(double& energy, double const* polarizability, double const* mu_field) const;
   ...
   private:
     ...
     */
    void compute_rho_k(double&       rho_re,
                       double&       rho_im,
                       double const* q,
                       double const* mu,
                       double const  kk[DIM],
