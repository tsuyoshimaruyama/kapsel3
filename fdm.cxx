  ...
  for (int i = 0; i < NX; i++) {
    for (int j = 0; j < NY; j++) {
      for (int k = 0; k < NZ; k++) {
        ...
        lap_u[0][im] =
            (1. + degree_oblique * degree_oblique) * d2ux_dx2 - (2. * degree_oblique * d2ux_dxdy) + d2ux_dy2 + d2ux_dz2;
        lap_u[1][im] =
            (1. + degree_oblique * degree_oblique) * d2uy_dx2 - (2. * degree_oblique * d2uy_dxdy) + d2uy_dy2 + d2uy_dz2;
        lap_u[2][im] =
            (1. + degree_oblique * degree_oblique) * d2uz_dx2 - (2. * degree_oblique * d2uz_dxdy) + d2uz_dy2 + d2uz_dz2;
      }
    }
  }
}
