...
int**      allocview_2d_int(int n1, int n2){return allocview_2d<int>(n1, n2);}
int***     allocview_3d_int(int n1, int n2, int n3){return allocview_3d<int>(n1, n2, n3);}
void       initview_2d_int(int n1, int n2, int* const i, int** &ii){return initview_2d<int>(n1, n2, i, ii);}
void       initview_3d_int(int n1, int n2, int n3, int* const i, int*** &iii){return initview_3d<int>(n1, n2, n3, i, iii);}
...
double**   allocview_2d_double(int n1, int n2){return allocview_2d<double>(n1, n2);}
double***  allocview_3d_double(int n1, int n2, int n3){return allocview_3d<double>(n1, n2, n3);}
void       initview_2d_double(int n1, int n2, double* const d, double** &dd){return initview_2d<double>(n1, n2, d, dd);}
void       initview_3d_double(int n1, int n2, int n3, double* const d, double*** &ddd){return initview_3d<double>(n1, n2, n3, d, ddd);}
