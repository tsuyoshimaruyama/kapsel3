...
inline void Copy_v1(double* ucp, double const* u) { Copy_v1_Primitive(ucp, u, R_SPACE); }
inline void Copy_v1_k(double* ucp, double const* u) { Copy_v1_Primitive(ucp, u, K_SPACE); }
