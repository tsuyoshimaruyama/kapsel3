...
void Gourmet_file_io(const char *infile
    ...
    */
	...
	if(SW_PT == spherical_particle){
		...
		if(SW_EQ == Electrolyte){
		    fprintf(stderr, "#%d %d %g %g %s %s %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f\n"
			    ,i
			    ,Particle_Numbers[i]
			    ,MASS_RATIOS[i]
			    ,Surface_charge[i]
		    ...
		    fprintf(stderr, "#%d %d %g %s %s %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f\n"
			    ,i
			    ,Particle_Numbers[i]
			    ,MASS_RATIOS[i]
			    ,JAX_name[janus_axis[i]]
...
>>>>>>> 132e3cc02875ed4f1b6cca6072e520d3360f67c3
