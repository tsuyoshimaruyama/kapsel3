...
void Make_phi_particle(double *phi, Particle *p) {
  ...
  int *     nlattice;
  nlattice = Ns;
  Make_phi_u_primitive(phi, dmy_up, p, SW_UP, DX, NP_domain, Sekibun_cell, nlattice);
}
...
void Make_phi_particle_OBL(double *phi, Particle *p) {
  ...
  int *     nlattice;
  nlattice = Ns;
  Make_phi_u_primitive_OBL(phi, dmy_up, p, SW_UP, DX, NP_domain, Sekibun_cell, nlattice);
}
