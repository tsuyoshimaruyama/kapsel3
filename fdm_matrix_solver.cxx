...
#pragma omp parallel for
    ...
    double adv_term = -0.5 * (+u_s[0][im] * (u[d][ijk2im(ip1, j, k)] - u[d][ijk2im(im1, j, k)]) / _2DX +
		...
		switch (d) {
		case 0:
        ps = pressure[im] - pressure[ijk2im(im1, j, k)] + pressure[ijk2im(i, jm1, k)] - pressure[ijk2im(im1, jm1, k)] +
             pressure[ijk2im(i, j, km1)] - pressure[ijk2im(im1, j, km1)] + pressure[ijk2im(i, jm1, km1)] -
             pressure[ijk2im(im1, jm1, km1)];
			break;
		case 1:
        ps = pressure[im] - pressure[ijk2im(i, jm1, k)] + pressure[ijk2im(im1, j, k)] - pressure[ijk2im(im1, jm1, k)] +
             pressure[ijk2im(i, j, km1)] - pressure[ijk2im(i, jm1, km1)] + pressure[ijk2im(im1, j, km1)] -
             pressure[ijk2im(im1, jm1, km1)];
			break;
		case 2:
        ps = pressure[im] - pressure[ijk2im(i, j, km1)] + pressure[ijk2im(im1, j, k)] - pressure[ijk2im(im1, j, km1)] +
             pressure[ijk2im(i, jm1, k)] - pressure[ijk2im(i, jm1, km1)] + pressure[ijk2im(im1, jm1, k)] -
             pressure[ijk2im(im1, jm1, km1)];
			break;
		default:
			break;
...
#pragma omp parallel for
    ...
    double adv_term = -0.5 *
        ...
        vt = (2. * g11 * eta_x + g21 * eta_y) * u_xx + g11 * eta_y * u_yx + g11 * eta_z * u_zx +
             (2. * g12 * eta_x + g22 * eta_y) * u_xy + g12 * eta_y * u_yy + g12 * eta_z * u_zy + g33 * eta_z * u_xz;
			break;
		case 1:
        vt = g21 * eta_x * u_xx + (g11 * eta_x + 2. * g21 * eta_y) * u_yx + g21 * eta_z * u_zx + g22 * eta_x * u_xy +
             (g12 * eta_x + 2. * g22 * eta_y) * u_yy + g22 * eta_z * u_zy + g33 * eta_z * u_yz;
			break;
		case 2:
    ...
    double bs =
        ...
        ps.w * A_XI * kiDX2 *
            ((1. + gt2) * (calc_gradient_norm_OBL(phi, ijk2im(ip1, j, k), gt) +
             ...
             calc_gradient_norm_OBL(phi, ijk2im(i, jp1, k), gt) + calc_gradient_norm_OBL(phi, ijk2im(i, jm1, k), gt) +
             calc_gradient_norm_OBL(phi, ijk2im(i, j, kp1), gt) + calc_gradient_norm_OBL(phi, ijk2im(i, j, km1), gt) -
             0.5 * gt *
            ...
            ((1. + gt2) * (potential_deriv(psi[ijk2im(ip1, j, k)]) + potential_deriv(psi[ijk2im(im1, j, k)])) +
             ...
             0.5 * gt *
                 (potential_deriv(psi[ijk2im(ip1, jp1, k)]) - potential_deriv(psi[ijk2im(ip1, jm1, k)]) -
                  potential_deriv(psi[ijk2im(im1, jp1, k)]) + potential_deriv(psi[ijk2im(im1, jm1, k)])) -
             2. * (3. + gt2) * potential_deriv(psi_im)) -
        kiDX2 * ((1. + gt2) * (potential_deriv(psi_o[ijk2im(ip1, j, k)]) + potential_deriv(psi_o[ijk2im(im1, j, k)])) +
                 potential_deriv(psi_o[ijk2im(i, jp1, k)]) + potential_deriv(psi_o[ijk2im(i, jm1, k)]) +
                 potential_deriv(psi_o[ijk2im(i, j, kp1)]) + potential_deriv(psi_o[ijk2im(i, j, km1)]) -
                 0.5 * gt *
