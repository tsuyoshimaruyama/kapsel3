...
inline void Mean_shear_sustaining_yforce_PBC(double **    zeta,
                                             double       uk_dc[DIM],
                                             double **    Shear_force,
                                             const CTime &jikan) {
    for (int d = 0; d < DIM; d++) {
...
inline void Mean_shear_sustaining_kforce_PBC(double **    zeta,
                                             double       uk_dc[DIM],
                                             double **    Shear_force,
                                             const CTime &jikan) {
    for (int d = 0; d < DIM; d++) {
...
// ion ??
inline void Field_solver_Euler(const int &        dim,
                               double **          zeta_k,
                               const CTime &      jikan,
                               double **          rhs,
...
inline void Rhs_NS_solute(Particle *p,
    ...
    for (int n = 0; n < N_spec; n++) {
        ...
        Solute_solver_rhs_nonlinear_x_single(
            grad_potential, rhs_solute[n], solute_flux, Valency_e[n], Onsager_coeff[n]);
