...
void init_ewald_sum(const double &lx, const double &ly, const double &lz, const int &num, const bool &charge, const bool &dipole) {
  ...
  ewald_sum = new ewald(ewald_cell, ewald_param.alpha, ewald_param.epsilon,
                        ewald_param.delta, ewald_param.conf, ewald_mem.num,
                        ewald_mem.charge, ewald_mem.dipole);
...
void compute_ewald_sum() {
  ...
  ewald_sum->compute(ewald_mem.energy, ewald_mem.force[0], ewald_mem.torque[0], ewald_mem.efield[0], ewald_mem.efield_grad[0][0], ewald_mem.r[0], dmy_q, dmy_mu, ewald_mem.num);
}
